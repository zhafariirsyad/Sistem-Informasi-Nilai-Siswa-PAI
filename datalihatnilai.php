<?php 
	...
	$perintah = new oop();
?>
<table border="1" id="tablesiswa" style="width: 100%;" class="table table-bordered table-hovered table-striped table-responsive">
		<tr>
			<th>NIS</th>
			<th>Nama</th>
			<th>Rombel</th>
		...
		<?php
			...
			$data = $perintah->select("tb_nilai_p WHERE rombel = '$id' ");

...
<form action="" method="post">
	<table id="tablek" style="width: 100%;" class="table table-bordered table-hovered table-striped table-responsive">
		<tr>
			<th>NIS</th>
			<th>Nama</th>
			<th>Rombel</th>
		...
		<?php
			$data = $perintah->select("tb_nilai_k WHERE rombel = '$id' ");
	...
	<a href="exportlihatnilaik.php?rombel=<?php echo $_POST['id'] ?>" class="btn btn-info ah">Export To Excel</a>
</form>